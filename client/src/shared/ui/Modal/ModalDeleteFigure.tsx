...
function ModalWindowFigureDelete({
    activeDelete,
    setActiveDelete,
    children,
  }: {
    ...
    return (
      <div className={activeDelete ? 'modal active' : 'modal'} onClick={() => setActiveDelete(false)}>
        <div
          className={activeDelete ? 'modal__content active' : 'modal__conten'}
          onClick={(e) => e.stopPropagation()}
        >
          <div className='div-button-ext'>
      <button className="botton-ext" onClick={() => setActiveDelete(false)}>
...
export default ModalWindowFigureDelete;