...
function ModalWindowFigureUpdate({
    activeUpdate,
    setActiveUpdate,
    children,
  }: {
    ...
    return (
      <div className={activeUpdate ? 'modal active' : 'modal'} onClick={() => setActiveUpdate(false)}>
        <div
          className={activeUpdate ? 'modal__content active' : 'modal__conten'}
          onClick={(e) => e.stopPropagation()}
        >
            <div className='div-button-ext'>
      <button className="botton-ext" onClick={() => setActiveUpdate(false)}>
...
export default ModalWindowFigureUpdate;